...
urlpatterns = [
    ...
    path('on-air-today/', views.on_air_today, name='on_air_today'),
    ...
    # Password change
    path('password-change/', au_views.PasswordChangeView.as_view(
         success_url=reverse_lazy('my_serials:password_change_done')),
         name='password_change'),
    path('password-change/done/', au_views.PasswordChangeDoneView.as_view(),
         name='password_change_done'),
    # Password reset
    path('password-reset/', au_views.PasswordResetView.as_view(
         success_url=reverse_lazy('my_serials:password_reset_done')),
         name='password_reset'),
    path('password-reset/done/', au_views.PasswordResetDoneView.as_view(),
